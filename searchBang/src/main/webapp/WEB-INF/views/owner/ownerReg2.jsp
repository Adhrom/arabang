...
<link rel="stylesheet" href="/searchBang/css/owner/ownerReg2.css">
		...
		<div class="input-box">
			...
			<div class="input-box-value">
				<form name="regOwner" method="post">
					<table>
						...
						<tr>
							<td style="width: 80%"><input type="email" class="frmdate"
								id="ownerEmail" name="ownerEmail" readonly="readonly"  placeholder="&nbsp;인증 버튼을 눌러주세요" ></td>
							<td style="width: 20%"><a
					...
					<div id="btn">
							<button class="button" id="back">이전</button>
							<button class="button" type="button" id="next">다음</button>
