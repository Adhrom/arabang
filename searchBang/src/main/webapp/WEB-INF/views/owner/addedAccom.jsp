...
<body>
	...
	<section class="section"
		style="width: 1000px; margin: 70px auto;">
		<h1>숙소 추가 페이지</h1>
		<hr/>
		...
		<div id = "left" style="width: 450px; float: left;">
			...
			<div id="accomtype" class="checks etrans divmargin">
				<strong>업체타입</strong><div class="divmargin2"></div>&nbsp;
						<input type="radio" name="accomType" id="hotel" value="hotel"><label for="hotel">호텔</label>&nbsp;&nbsp;
						<input type="radio" name="accomType" id="motel" value="motel"><label for="motel">모텔</label>&nbsp;&nbsp;
						<input type="radio" name="accomType" id="pention" value="pention"><label for="pention">펜션/풀빌라</label>&nbsp;&nbsp;
						<input type="radio" name="accomType" id="guesthouse" value="guesthouse"><label for="guesthouse">게스트 하우스</label>
			</div>
				...
				<table style="width: 100%;">
					<tr>
						<td colspan="2" style="padding: 5px 0px 5px 0px;">
							<input type="text" id="accomName" name="accomName" placeholder="숙소이름" style="width: 96%; height: 30px; padding-left: 15px;">
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<input type="text" id="accomAddress" name="accomAddress" placeholder="주소" readonly="readonly" style="width: 96%; height: 30px; padding-left: 15px;">
						</td>
					</tr>
					<tr>
						<td width="85%">
							<input type="text" id="accomAddress2" name="accomAddress2" placeholder="나머지 주소" style="width: 99%; height: 30px; padding-left: 15px;">
						</td>
						<td style="padding-left: 15px;">
							<input type="button" value="검색" onclick="execDaumPostcode()" class="button">
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<input type="text" id="accomPhone" name="accomPhone" placeholder="숙소 전화번호" style="width: 96%; height: 30px; padding-left: 15px;">
						</td>
					</tr>
				</table>
			</div>
		...
		<div style="clear: both; width: 100px; margin: 0 auto; padding-right: 50px;">
