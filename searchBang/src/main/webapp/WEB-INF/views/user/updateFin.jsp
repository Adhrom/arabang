...
<body>
	...
	<div class="cd-main-content" >
		<div id="welcomeFinish">
			...
			<h1 id="title-b">알아방 가족 신청 페이지</h1>

			<div id="welcome">
				<img id="commemoration" alt="웰컴이미지" src="/searchBang/img/owner/commemoration.png">
				<ul>
					<li class="text" id="success">정보수정이 성공적으로 완료되었습니다.</li>
					<!-- <li class="text" id="family">알아방의 가족이 되신것을 환영합니다.</li> -->
				</ul>
				<div style="width: 100px; margin: 0 auto;">
					<a href="index.bang"><button class="button" >홈으로</button></a>
				</div>
				<br />
			</div>
		</div>
